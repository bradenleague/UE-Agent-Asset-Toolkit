...
TOOLS = [
    ...
    {
        "name": "inspect_asset",
        "description": "Get all properties and values of an asset. Use summarize=True for focused output, type_only=True for just asset type/metadata. For Blueprints, use detail='graph' for enriched graph metadata (K2 node wiring, members, function flags, delegates/bindings), or detail='graph-summary' for lightweight metadata (members, functions, delegates) without the graph.",
